            ...
            <form>
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <input type="text" className="input input-bordered w-full" name="customer-name" />
                </label>
                <label className="form-control w-full mb-3">
                  <div className="label">
                    <span className="label-text text-black">Alias Name</span>
                  </div>
                  <input type="text" className="input input-bordered w-full" name="customer-alias-name" />
                </label>
              </div>
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <select className="select select-bordered w-full" name="customer-gender">
                ...
                <label className="form-control w-full mb-3">
                  ...
                  <select className="select select-bordered w-full" name="customer-id-type">
                ...
                <label className="form-control w-full mb-3">
                  ...
                  <input type="text" className="input input-bordered w-full" name="customer-id-card-no" />
                </label>
              </div>
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <input type="date" className="input input-bordered w-full" name="customer-date-of-birth" />
                </label>
                <label className="form-control w-full mb-3">
                  <div className="label">
                    <span className="label-text text-black">Place of Birth</span>
                  </div>
                  <input type="text" className="input input-bordered w-full" name="customer-place-of-birth" />
                </label>
              </div>
              <label className="form-control w-full mb-3">
                <div className="label">
              ...
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <select className="select select-bordered w-full" name="customer-country">
                    <option value=""></option>
                ...
                <label className="form-control w-full mb-3">
                  ...
                  <select className="select select-bordered w-full" name="customer-province">
                    <option value=""></option>
                ...
                <label className="form-control w-full mb-3">
                  ...
                  <input type="text" className="input input-bordered w-full" name="customer-city" />
                </label>
              </div>
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <input type="number" className="input input-bordered w-full" name="customer-country-phone-code" />
                </label>
                <label className="form-control w-full mb-3">
                  <div className="label">
                    <span className="label-text text-black">Phone Number</span>
                  </div>
                  <input type="number" className="input input-bordered w-full" name="customer-phone-number" />
                </label>
              </div>
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <input type="email" className="input input-bordered w-full" name="customer-email" />
                </label>
                <label className="form-control w-full mb-3">
                  <div className="label">
                    <span className="label-text text-black">Reference</span>
                  </div>
                  <select className="select select-bordered w-full" name="customer-reference">
              ...
              <div className="flex gap-4">
                <label className="form-control w-full mb-3">
                  ...
                  <select className="select select-bordered w-full" name="customer-customer-status">
                ...
                <label className="form-control w-full mb-3">
                  ...
                  <select className="select select-bordered w-full" name="customer-active-status">
